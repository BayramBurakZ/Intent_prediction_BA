...
path = r'../data/test_data_recorded/hand_tracking.csv'
...
#new column names to
columns = ['time', 'source', 'hand', 'x', 'y', 'z']
...
df_right.to_csv(r'../data/test_data_recorded/processed_tracking' + '.csv', index=False)
