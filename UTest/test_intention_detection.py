...
class TestIntentionRecognition:
    ...
    def evaluate_results(self, results, target_index, test_id):
        ...
        Parameters:
            results (list): A list containing the output data from the test.
        ...
        for result in results:
            ...
            probabilities_target.append(result[2].pop(target_index))
        ...
        for i, prob in enumerate(probabilities_target):
            ...
            # passing conditions. Save data at first time reaching 60% with sample size greater then 3
            if prob >= 60.0 and not prob_60_reached and sample_sizes[i][target_index] >= 3:
